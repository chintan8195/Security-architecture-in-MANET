...
set count($authenticationlevel) 0

     for {set j 0} {$j < $val(nn) } { incr j } {
                  #   $h($trustlevel-$j)=intrusion detection
                 if {$h($trustlevel-$j) <  j} {

                                set count($trustlevel) [expr $count($trustlevel)]
                                set n($trustlevel-$count($trustlevel)) $j
...
$tcp11 set maxcwnd_ 11      #max congestion window(congestion control
and traffic)
$tcp11 set fid_ 4
...
$ns at 61.0 "$n(28) label AUTHENTICATOR"
...
$ns at 20.0 "$ns trace-annotate \"Malicious node detection\""
  $ns at 21.1 "$ns trace-annotate \"TO SEARCH  CH NODE\""
  $ns at 22.0 "$ns trace-annotate \"TO FIND  THE SEARCH  CH NODE\""
$ns at 40.09 "$ns trace-annotate \"Removal of node\""
 $ns at 41.0 "$ns trace-annotate \"BACK BONE TREE PROCESS\""
  $ns at 61.0 "$ns trace-annotate \"TO FIND THE BACKBONE THE NODE AND
SINK NODE\""
  $ns at 61.1 "$ns trace-annotate \"COMMUNICATION BT CH AND BACK BONE
AND SINK\""
$ns at 70.0 "$ns trace-annotate \"Removal of malicious node\""
...
$n(2) color black
$ns at 2.0 "$n(2) color cyan"
$n(29) color black
$ns at 2.0 "$n(29) color cyan"
$n(26) color black
$ns at 2.0 "$n(26) color cyan"
$n(30) color black
$ns at 2.0 "$n(30) color cyan"
$n(28) color black
$ns at 2.0 "$n(28) color cyan"
$n(27) color black
$ns at 2.0 "$n(27) color cyan"
$n(2) color red
...
$n(14) color white
$ns at 22.79 "$n(14) color white"
$n(27) color pink
$ns at 61.0 "$n(27) color orange"
$n(28) color blue
$ns at 61.0 "$n(28) color blue"

$n(11) color white
$ns at 76.64 "$n(11) color white"
...
close $a7
exec nam ntf.nam &
exec xgraph     WATCH_DOG.tr  -t "Throughput" -x "RUNNING TIME" -y
"DISTANCE" -m  &
exec xgraph     WATCHDOG_1.tr  -t "Bandwidth" -x "RUNNING TIME" -y
"DISTANCE" -m  &
exec xgraph     WATCHDOG_2.tr   -t "Power consumption" -x "RUNNING
TIME" -y "DISTANCE" -m  &
